...
3. Generate branch name from task type:
   ...
   - Bug fix: `fix/<short-description>` (e.g., `fix/auth-token-expiry`)
...
- ADR-035: TypeORM (ORM, synchronize: true)
