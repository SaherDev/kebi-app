...
| Send a chat message | `Impact.Light` | The message left your hands — quiet ack |
| Swap a "swap to" pick into the recommendation | `Selection` | Reversible commit — picker-like choice |
